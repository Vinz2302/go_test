...
type IHelperDatabases interface {
	PaginationPostgresSQL(structResultQuery interface{}, rawQuery *string, stuctPagination *QueryParamPaginationEntity, fieldToSearchString []string, sqlOrder [1]string) (interface{}, error)
}
